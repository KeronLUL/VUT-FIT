...
int main(int argc, char *argv[])	{
    ...
    if(showFirstLast)
        printf("\nFirst: %d, Last: %d\n",TEMPLIST.First->data,TEMPLIST.Last->data);
                      /* Testy 06 až 10 odpovídají základním testům 03 až 07. */
    printf("\n[TEST06]\n");
    ...
    if(showFirstLast)
        printf("\nFirst: %d, Last: %d\n",TEMPLIST.First->data,TEMPLIST.Last->data);
                      /* Testy 17 až 20 odpovídají základním testům 12 až 15. */
    printf("\n[TEST17]\n");
    ...
    if(showFirstLast)
        printf("\nFirst: %d, Last: %d\n",TEMPLIST.First->data,TEMPLIST.Last->data);
                        /* Dále se již od základních testů výrazně odchýlíme. */
    printf("\n[TEST21]\n");
